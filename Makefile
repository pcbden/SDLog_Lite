##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [4.6.0.1-B1] date: [Thu Mar 12 01:50:43 UZT 2026] 
##########################################################################################################################
...
# C sources
C_SOURCES =  \
SDLog/Sources/modbus_master.c \
SDLog/Sources/sensor_reader.c \
SDLog/Sources/file_manager.c \
SDLog/Sources/application.c \
SDLog/Sources/modem_api.c \
SDLog/Sources/at_command_driver.c \
...
#######################################
# link script
LDSCRIPT = STM32L151XX_FLASH.ld

# libraries
LIBS = -lc -lm -lnosys 
LIBDIR = 
#LDFLAGS = $(MCU) -specs=nano.specs -T$(LDSCRIPT) $(LIBDIR) $(LIBS) -Wl,-Map=$(BUILD_DIR)/$(TARGET).map,--cref -Wl,--gc-sections
LDFLAGS = $(MCU) -specs=nano.specs -T$(LDSCRIPT) $(LIBDIR) $(LIBS) -Wl,-Map=$(BUILD_DIR)/$(TARGET).map,--cref -Wl,--gc-sections -Wl,-u,_printf_float -Wl,-u,_scanf_float
