...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, L1_B_Pin|L1_G_Pin|L1_R_Pin|L2_B_Pin
                          |L2_R_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : RE_Pin ON_5V_Pin */
  GPIO_InitStruct.Pin = RE_Pin|ON_5V_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
