...
extern uint8_t uart_modem_rx_buffer[UART_BUFFER_SIZE];
extern uint8_t uart_sensor_rx_buffer[UART_BUFFER_SIZE];
extern uint8_t uart_aux_rx_buffer[UART_BUFFER_SIZE];
